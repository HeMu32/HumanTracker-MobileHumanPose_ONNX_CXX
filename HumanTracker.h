...
// Params for Yolo-fastest module
#define objThreshold  0.25
#define confThreshold 0.1
#define nmsThreshold  0.3

// Threshould of continuous frames that has a person detected by Yolo
// to confrim the detection of a person.
// Aims to use tempol correlation to takel false detection.
#define YOLO_CONFRIM_DEC_FRAME_THRESH 4
...
private:
    // This block: Tracking realted methods and params. 
    ...
    unsigned    uiMaxTLCnt  = 8;    // Tolerence of using momentum-opti flow bound box. 
    unsigned    uiYoloDec   = 0;    // Counter of continuous frames that has a person detected by Yolo, got reset on TRACK LOST.
                                    // Aims to use tempol correlation to takel false detection.
                                    // We want to have Yolo to say "there's a person" in at least 4 continuous frames, to confrim a detection, when entering tracking
...
private:
    // This block: Yolo realted methods and params. 
